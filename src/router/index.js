...
const cmsRouterMap = [webSite, systemSet, systemStatus, personAndAuthor, extensions, organization, department, user, role, permission, permissiongroup, operation, application]
