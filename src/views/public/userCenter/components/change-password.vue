  ...
  <div class="change-password">
    <el-form :model="formModel" status-icon :rules="rules2" ref="form" label-width="100px" size="small">
      ...
      <el-form-item label="新密码" prop="newPassword">
        <el-input type="password" v-model="formModel.newPassword" auto-complete="off"/>
      </el-form-item>
      <el-form-item label="确认密码" prop="checkPassword">
        <el-input type="password" v-model="formModel.checkPassword" auto-complete="off"/>
      </el-form-item>
      <el-form-item>
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          return new Promise((resolve, reject) => {
            resetPassword({userNewPwd:this.formModel.newPassword, userOldPwd:this.formModel.oldPassword})
              .then((response) => {
                this.$message({
                  message: '修改成功！',
                  type: 'success'
