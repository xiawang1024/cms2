<template>
  <div class="usercenter">
    <div class="user-info">
      <el-form label-position="left" inline ref="form" :model="userForm" :rules="userFormRules">
        <el-form-item label="用户名">
          <span>{{ userInfo.userName }}</span>
        </el-form-item>
        <!-- <el-form-item label="姓名" prop="cnName">
          <span v-show="!formVisible">{{ 111 }}</span>
          <el-input v-show="formVisible" v-model="userForm.cnName"></el-input>
        </el-form-item> -->
        <!-- <el-form-item label="邮箱" prop="email">
          <span v-show="!formVisible">{{ 222 }}</span>
          <el-input v-show="formVisible" v-model="userForm.email"></el-input>
        </el-form-item> -->
        <!-- <el-form-item label="手机号" prop="mobilePhone">
          <span v-show="!formVisible">{{333 }}</span>
        ...
        <el-form-item >
          ...
          <el-button type="primary" size="small" @click="showChangePassword">修改密码</el-button>
        </el-form-item>
    ...
    <el-dialog title="修改密码" :visible.sync="passwordVisible" width="500px">
      <changePassword @success="closeChangePassword('success')" @cancel="closeChangePassword('cancel')"/>
    </el-dialog>
  </div>
</template>
<script>
