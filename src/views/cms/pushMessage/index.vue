<template>
  <div class="push-message">
    ...
    <el-table :data="tableData" style="width: 100%" highlight-current-row>
      ...
      <el-table-column prop="operatorName" label="发布人员" width="150" show-overflow-tooltip />
  ...
  methods: {
    ...
    searchItem(data) {
      ...
      if (this.searchData.publistTime && this.searchData.publistTime.length) {
        this.searchData.startTime = handleDate(
          this.searchData.publistTime[0],
          "day"
        );
        this.searchData.endTime = handleDate(
          this.searchData.publistTime[1],
          "day"
        );
      }
