  ...
  methods: {
    ...
    submitSave(row) {
      ...
      if (this.requestType == "add") {
        ...
        if (this.selectRow == 5) {
          this.addGroupAttribute.value = this.moment(row.valuedate).format(
            "YYYY-MM-DD HH:mm:ss"
          );
          if (
            this.addGroupAttribute.value == "" ||
        ...
        if (this.selectRow == 3) {
          ...
          if (
            this.editGroupAttribute.value == "" ||
            this.editGroupAttribute.value == null
          ) {
            return this.$message({
              type: "error",
              message: "文本不能为空！"
        ...
        if (this.selectRow == 5) {
          this.editGroupAttribute.value = this.moment(row.valuedate).format(
            "YYYY-MM-DD HH:mm:ss"
          );
          if (
            this.editGroupAttribute.value == "Invalid date" ||
            this.editGroupAttribute.value == null
          ) {
            return this.$message({
              type: "error",
    ...
    search() {
      ...
      if (patt.test(this.searchAttributeById)) {
        ...
        _this.searchAttributeById == "" ||
        _this.searchAttributeById == null
      ) {
        return null;
      } else {
        _this.$message({
