  ...
  <div class="component-form-container">
    <el-form :model="componentForm">
      ...
      <el-form-item label="所属栏目">
        <ChannelSelect
          :channel-id="componentForm.channelId"
          @channelCascaderChange="channelCascaderChange"
        />
      </el-form-item>
      ...
      <el-form-item label="变量列表">
        <el-card class="varible-card">
          ...
          >
            ...
            <el-button @click.prevent="removeComponent(component)" size="mini" type="danger">删除</el-button>
          </el-form-item>
          <el-form-item>
            <el-button @click="addComponent" size="mini" type="primary">新增变量</el-button>
          </el-form-item>
        </el-card>
      </el-form-item>
      ...
      <el-form-item label="组件内容">
        <el-input
          :rows="15"
          v-model="componentForm.componentContent"
          type="textarea"
          class="content-textara"
        />
      </el-form-item>
    </el-form>
...
export default {
  ...
  methods: {
      ...
      return new Promise((resolve, reject) => {
        fetchComponent(_this.chooseComponentId)
          .then(response => {
            ...
            _this.componentForm.componentVariablesList = response.data.result
              .componentVariablesList
              ? response.data.result.componentVariablesList
              : [];
            resolve();
          })
          .catch(error => {
    ...
    addComponent() {
      console.log(this.componentForm, "11111");
    ...
    handleAdd() {
      ...
      var _this = this;
      if (
        _this.componentForm.componentId === undefined ||
        _this.componentForm.componentId === "" ||
        _this.componentForm.componentId === null
      ) {
        // create
        return new Promise((resolve, reject) => {
