  ...
  methods: {
    ...
    handleDialogObjToList() {
      ...
      if (currentOpeIdx === -1) {
        ...
        _this.dictObj.details[currentOpeIdx].dictDetailName = _this.docSourceForm.dictDetailName
        _this.dictObj.details[currentOpeIdx].dictDetailValue = _this.docSourceForm.dictDetailValue
      }
    },
    // 查询对象
    fetchDict() {
