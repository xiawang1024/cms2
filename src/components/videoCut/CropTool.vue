                ...
                <div class="time-input-area">
                  ...
                  <div class="time-input">
                    <input
                      ...
                      @change="startTimeChange($event, getOriginalIndex(index), 0)"
                    >
                    :
                    <input
                      type="text"
                      :value="item.startTimeArr[1]"
                      @change="startTimeChange($event, getOriginalIndex(index), 1)"
                    >
                    :
                    <input
                      type="text"
                      :value="item.startTimeArr[2]"
                      @change="startTimeChange($event, getOriginalIndex(index), 2)"
                    >
                  </div>
                </div>
                ...
                <div class="time-input-area">
                  ...
                  <div class="time-input">
                    <input
                      ...
                      @change="endTimeChange($event, getOriginalIndex(index), 0)"
                    >
                    :
                    <input
                      type="text"
                      :value="item.endTimeArr[1]"
                      @change="endTimeChange($event, getOriginalIndex(index), 1)"
                    >
                    :
                    <input
                      type="text"
                      :value="item.endTimeArr[2]"
                      @change="endTimeChange($event, getOriginalIndex(index), 2)"
                    >
                  </div>
                </div>
              </div>
          ...
          <div class="time-input-area">
            ...
            <div class="time-input">
              <input
                ...
                @change="startTimeChange($event, 0, 0)"
                @focus="inputFocus()"
              >
              :
              <input
                ...
                @change="startTimeChange($event, 0, 1)"
                @focus="inputFocus()"
              >
              :
              <input
                ...
                @change="startTimeChange($event, 0, 2)"
                @focus="inputFocus()"
              >
            </div>
          </div>
          ...
          <div class="time-input-area">
            ...
            <div class="time-input">
              <input
                ...
                @change="endTimeChange($event, 0, 0)"
                @focus="inputFocus()"
              >
              :
              <input
                ...
                @change="endTimeChange($event, 0, 1)"
                @focus="inputFocus()"
              >
              :
              <input
                ...
                @change="endTimeChange($event, 0, 2)"
                @focus="inputFocus()"
              >
            </div>
          </div>
...
<script>
import formatTime from "@/utils/videoCut/formatTime";
import simplifySecond from "@/utils/videoCut/simplifySecond";
import throttle from "@/utils/videoCut/throttle";
...
export default {
  ...
  methods: {
    ...
    endTimeChange(event, cropItemListIndex, timeArrIndex) {
      ...
      if (value < 0 || value > 59 || value !== value) {
        ...
        if (currentItem.endTime < currentItem.startTime) {
          ...
          this.$message.error("结束值必须大于起始值");
          console.log("结束值必须大于起始值");
        }
        // 结束时间不能大于总时长
        const duration = this.duration;
        if (currentItem.endTime > duration) {
          this.$message.error("结束值不能大于总时长");
    ...
    confirmCrop() {
      ...
      //添加 url, id, order字段
      tempCropItemList.map((item, index) => {
...
@import "@/components/videoCut/CropTool.scss";
</style>
