<template>
  <div class="splicing-wrap">
    ...
    <div class="splicing-btn">
      ...
      <el-button :disabled="Boolean(contextMenu.docId) && (docInfor.articleStatus ==1) && (baseInfor.userName !== docInfor.createUser)" type = "primary" size="mini" @click = "save('docContentForm', '1')">保存并发布</el-button>
    </div>
  </div>
</template>
<script>
